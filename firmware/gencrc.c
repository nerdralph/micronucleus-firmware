...
int main()
{
    ...
    printf ("#define DDCRC1 0x%X\n", crc16);
    crc16 = crc16_8(&DDesc[8], 8);
    printf ("#define DDCRC2 0x%X\n", crc16);
    crc16 = crc16_8(&DDesc[16], 3);
    printf ("#define DDCRC3 0x%X\n", crc16);

    crc16 = crc16_8(&CDesc[0], 2);
    printf ("#define CDCRC1 0x%X\n", crc16);
    crc16 = crc16_8(&CDesc[8], 2);
    printf ("#define CDCRC2 0x%X\n", crc16);
}
